//  PriorityQueue.swift
//  Created by GoThink Learning Solutions on 6/12/16.
import Foundation
//---------------------------------------------------------------
public class PriorityQueue <I, P:Comparable>
    ...
    //-----------------------------------------------------------
    // The children of node N are at 2N and 2N+1. For
    // that to work, the array has to be 1 indexed. The
    // easy solution is just not to use element 0.
    ...
    public required init( dictionaryLiteral elements:
        (I, P)...) {
...
//----------------------------------------------------------------
public func += <I,P> ( lhs: PriorityQueue<I,P>,
    rhs: (I,P)){
        lhs.append( rhs )
}
//---------------------------------------------------------------
